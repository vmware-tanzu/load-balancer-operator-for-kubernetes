...
func (r *AKODeploymentConfigReconciler) reconcileNormal(
	...
	return phases.ReconcilePhases(ctx, log, obj, []phases.ReconcilePhase{r.reconcileAVI, r.reconcileClusters})
}
...
func (r *AKODeploymentConfigReconciler) reconcileDelete(
	...
	return phases.ReconcilePhases(ctx, log, obj, []phases.ReconcilePhase{r.reconcileClustersDelete, r.reconcileAVIDelete})
}
