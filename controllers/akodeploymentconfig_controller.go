...
func (r *AKODeploymentConfigReconciler) Reconcile(req ctrl.Request) (ctrl.Result, error) {
	_ = context.Background()
	_ = r.Log.WithValues("akodeploymentconfig", req.NamespacedName)
...
func (r *AKODeploymentConfigReconciler) SetupWithManager(mgr ctrl.Manager) error {
	return ctrl.NewControllerManagedBy(mgr).
		For(&networkv1alpha1.AKODeploymentConfig{}).
		Complete(r)
}
