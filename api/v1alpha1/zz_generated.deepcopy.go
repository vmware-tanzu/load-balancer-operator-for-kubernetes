...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ExtraAviConfig) DeepCopyInto(out *ExtraAviConfig) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ExtraAviConfig.
func (in *ExtraAviConfig) DeepCopy() *ExtraAviConfig {
	if in == nil {
		return nil
	}
	out := new(ExtraAviConfig)
	in.DeepCopyInto(out)
	return out
}
